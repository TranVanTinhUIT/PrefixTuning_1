...
def main():
    ...
    if args.task_mode == 'data2text':
        ...
        if args.task_mode == 'classify-sentiment':
            ...
            test_path = settings.OUTPUT_PATH + "/contrast_LM/transformers/examples/text-classification/glue_data/AG-news/dev1.tsv"
        ...
        if args.task_mode == 'cnndm':
            test_path = settings.OUTPUT_PATH + "/contrast_LM/transformers/examples/seq2seq/cnn_dm/test.source"
            max_source_length = 512
            max_target_length = 142
            prompt_text_dict = read_sum_files(test_path, tokenizer, max_source_length, max_target_length)
        elif args.task_mode == 'xsum':
            test_path = settings.OUTPUT_PATH + "/contrast_LM/transformers/examples/seq2seq/xsum/test.source"
            max_source_length = 512
